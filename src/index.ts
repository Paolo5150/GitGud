...
import { ChangeDir, GitBranchName, GitChangeList, GitIsRepoValid, GitStatus, GitTopLevel, GitUntrackedFiles } from './gitcmds';
...
async function Refresh(){
  ...
  catch(error)
  {
    ...
    mainWindow.webContents.send('update-log','Looks like there are no commits, is this a fresh repo?')
  }
